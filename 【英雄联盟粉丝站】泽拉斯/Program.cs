    ...
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
          ...
          //Create the menu
            ...
            Config.SubMenu("R").AddItem(new MenuItem("rMode", "妯″紡").SetValue(new StringList(new[] { "姝ｅ父", "鑷畾涔塱", "OnTap"})));
            ...
            Config.SubMenu("R").AddItem(new MenuItem("PingRKillable", "Ping鍙潃姝荤洰鏍噄)").SetValue(true));
            Config.SubMenu("R").AddItem(new MenuItem("BlockMovement", "鏈夐殰纰嶇墿鏃剁瓑寰呭紑R").SetValue(false));
           ...
           Config.AddSubMenu(new Menu("琛ュ叺", "Farm"));
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("AutoEGC", "鑷姩寮€E闃睪ank").SetValue(true));
            ...
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("RRangeM", "R 鑼冨洿 灏忓湴鍥緄").SetValue(new Circle(false,
            ...
            Game.PrintChat("WWW.LOL520.CC-娉芥媺鏂垚鍔熻浇鍏");
