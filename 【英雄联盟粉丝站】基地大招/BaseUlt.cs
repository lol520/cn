...
namespace BaseUlt2
{
    ...
    class BaseUlt
    {
        ...
        public BaseUlt()
        {
            ...
            _menu.AddItem(new MenuItem("extraDelay", "棰濆寤惰繜").SetValue(new Slider(0, -2000, 2000)));
            ...
            var teamUlt = _menu.AddSubMenu(new Menu("鑻遍泟鑱旂洘绮変笣绔檌", "LOL520.CC"));
            ...
            Game.PrintChat("<font color=\"#1eff00\">鍩哄湴澶ф嫑</font> - <font color=\"#00BFFF\">杞藉叆鎴愬姛锛岃嫳闆勮仈鐩熺矇涓濈珯锛圠OL520.cc鍔╂偍娓告垙鎰夊揩锛侊級</font>");
        }
