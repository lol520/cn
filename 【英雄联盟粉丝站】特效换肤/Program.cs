    ...
    class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                Config = new Menu("銆怢OL520.cc銆戠壒鏁堟崲鑲ゃ劎", "Skin Changer", true);
                ...
                Game.PrintChat("<font color=\"#0066FF\">[<font color=\"#FFFFFF\">madk</font>]</font><font color=\"#FFFFFF\"> LOL520.cc鐗规晥鎹㈣偆鍔犺浇鎴愬姛!</font>");
            }
            catch(Exception ex)
            {
                Game.PrintChat("<font color=\"#0066FF\">[<font color=\"#FFFFFF\">madk</font>]</font><font color=\"#FFFFFF\"> 鐗规晥鎹㈣偆鍔犺浇澶辫触锛岃閲嶈瘯</font>");
