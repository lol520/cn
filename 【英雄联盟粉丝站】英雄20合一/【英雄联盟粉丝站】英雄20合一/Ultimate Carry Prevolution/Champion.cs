...
namespace Ultimate_Carry_Prevolution
{
	class Champion
	{
		...
		private void LoadBasics()
		{
			...
			Menu.SubMenu("Credits").AddItem(new MenuItem("Lexxes", "Lexxes"));
			Menu.SubMenu("Credits").AddItem(new MenuItem("xSalice", "xSalice"));
			...
			Menu.AddSubMenu(new Menu("鑻遍泟鑱旂洘绮変笣绔檌", "LOL520.CC"));
				Menu.SubMenu("LOL520.CC").AddItem(new MenuItem("qun", "浜ゆ祦缇わ細21422249"));
				Menu.SubMenu("LOL520.CC").AddItem(new MenuItem("qun2", "浜ゆ祦2缇わ細397773763"));
