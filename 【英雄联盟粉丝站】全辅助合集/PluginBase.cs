...
namespace Support
{
    ...
    public abstract class PluginBase
    {
        ...
        protected PluginBase()
        {
            ...
            Helpers.PrintMessage(string.Format("{0} by {1} v.{2} 杞藉叆鎴愬姛锛岃嫳闆勮仈鐩熺矇涓濈珯锛圠OL520.cc鍔╂偍娓告垙鎰夊揩锛侊級", ChampionName, Author, Version));
        }
        ...
        {
            Config = new Menu("杈呭姪: " + Player.ChampionName, Player.ChampionName, true);
            ...
            MiscConfig.AddList("AttackMinions", "鏀诲嚮灏忓叺", new[] {"Smart", "Never", "Always"});
            MiscConfig.AddBool("AttackChampions", "鏀诲嚮鑻遍泟", true);
